...
stack.assignAction(lambda **kw: None, "Get all sources")
stack.pushCommand("add")
stack.pushVariable("name")
stack.pushVariable("url")
stack.assignAction(lambda name, url, **kw: None, "Add new remote")
stack.pop()
stack.pop()
stack.pop()
stack.pushCommand("remove")
stack.pushVariable("name")
stack.assignAction(lambda name, **kw: None, "Remove remote")
stack.pop()
stack.pop()
